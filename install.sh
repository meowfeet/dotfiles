...
version="$(nix eval --raw /mnt/etc/nixos#nixosConfigurations.nixos.config.system.nixos.release)"
...
nixos-install --no-channel-copy --root /mnt --flake /mnt/etc/nixos#nixos --no-root-passwd
